...
public class Matrix {
    ...
    public void readMatrixPointFromKeyboard () {
        ...
        this.matrix = new double[count][2];
        this.row = count;
        ...
        for (int i = 0; i < this.row; i++) {
            ...
            inputitem.readPoint();
            this.matrix[i][0] = inputitem.x;
            this.matrix[i][1] = inputitem.y;
        }
        //input.close();
    }
    ...
    public void readMatrixPointFromFile (String filePath) {
        try {
            ...
            this.row = inputMatrix.size();
            this.column = 2;

            this.matrix = new double[this.row][2];
        
            for (int i = 0; i < this.row; i++) {
                this.matrix[i][0] = inputMatrix.get(i)[0];
                this.matrix[i][1] = inputMatrix.get(i)[1];
            }
